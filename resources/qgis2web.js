...
map.getView().fit([-11325773.929006, 2072379.283490, -10853240.035204, 2315206.130733], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Municipios Industriales en el Estado de México </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (124 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'En este mapa se puede observar los municipios del Estado de México al igual que el desarrollo industrial que tiene cada uno ';
            }
